...
class ChatViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //let messageArray = ["First message", "Second Message lkqjhflkjhflwdfkjghlwfkjhlsw hlkdbclyblkjhblfyvl u liuy uy mhudmly lfgwhlkhjwl iy lwdfiug lkwdhu luqifeybliuh lqkuhl qglg lkgdwlk glkgfd jhgdfw kjwfhg ", "Third message"]
    ...
    func retrieveMessages() {
        ...
        messagesDB.observe(.childAdded) { (snapshot) in
            ...
            // creates an IndexPath for the last row of the messageArray
            let lastMessageIndex = self.messagesArray.count - 1
            let indexPath = IndexPath(row: lastMessageIndex, section: 0)
            // Scrolls the last message array to the bottom of the TableView
